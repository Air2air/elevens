...
import { TrendsInner, TrendsHeader, ButtonRow } from "./trendsComponents";
          ...
          <TrendsHeader>
            ...
            <ButtonRow>
              <ButtonDesktop
                ...
                buttonColor={
                  xAxisType === "cap_current" ? COLOR_CHART_BAR : COLOR_BASE_6
                }
              >
                Market Cap
              </ButtonDesktop>
              ...
              <ButtonDesktop
                ...
                buttonColor={
                  xAxisType === "cagr_current" ? COLOR_GREEN : COLOR_BASE_6
                }
              >
                CAGR
              </ButtonDesktop>
